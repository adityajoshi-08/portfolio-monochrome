  ...
  return (
      <div className='bg-[#D2D2D2] h-[100vh] w-full flex justify-center'>
        <div className="container flex flex-col justify-center items-center gap-8">
          <h1 className='contact-text text-white sm:text-[15rem] lg:text-[25rem] font-futura font-regular stroke-[#363636] tracking-tight leading-none'>CONTACT</h1>
          <div className="flex flex-col items-center justify-center gap-3">
            <a href="mailto:adityajoshi304@gmail.com" target='_blank' className='email text-[#363636] hover:text-white  font-futura font-regular stroke-[#363636] tracking-tight leading-none transition-all duration-300'>ADITYAJOSHI304@GMAIL.COM</a>
