...
export default function Hero() {
  ...
  return (
    <div className='h-[100vh] flex flex-col justify-evenly items-center text-center'>
      ...
      <div className="mid">
        <div className="row">
          <h1 className="name font-futura text-8xl font-semibold stroke-black text-[#363636] tracking-tighter">ADITYA JOSHI</h1>
        </div>
        <div className="row flex relative mt-7">
